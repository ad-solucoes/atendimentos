<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <a href="{{ route('admin.equipes_saude.formulario') }}"
           ...
           <i class="fa-solid fa-plus"></i> Nova Equipe de Saúde
        </a>
    </div>
        ...
        <table class="hidden md:table min-w-full">
            <thead>
                <tr class="bg-gray-100 text-left text-sm uppercase text-gray-600">
                    <th class="px-4 py-3">Nome da Equipe de Saúde</th>
            ...
            <tbody>
                @forelse ($equipes_saude as $equipe_saude)
                    <tr class="border-t hover:bg-gray-50 transition">
                        <td class="px-4 py-2 font-medium text-gray-800">{{ $equipe_saude->equipe_saude_nome }}</td>
