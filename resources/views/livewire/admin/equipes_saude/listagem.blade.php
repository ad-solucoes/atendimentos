            ...
            <div class="flex flex-col md:items-end">
                ...
                <div class="flex items-center justify-between md:justify-end gap-3">
                    ...
                    <small class="text-gray-600 text-sm">
                        ...
                        Total: <span class="font-semibold text-gray-800">{{ $equipes_saude->total() }}</span>
                        registro(s)
                    </small>

                    @can('Adicionar Equipe de Saude')
            ...
            <thead>
                <tr class="bg-gray-100 text-left text-sm text-gray-600">
                    <th class="px-2 py-2 text-center font-semibold" width="100"
                        wire:click="sortByField('equipe_saude_status')" style="cursor: pointer;"
                        title="Clique para ordenar">
                        Status
                        @include('livewire.partials._sort-icon', ['field' => 'equipe_saude_status'])
                    </th>
                    <th class="px-2 py-2 font-semibold" wire:click="sortByField('equipe_saude_nome')"
            ...
            <tbody>
                ...
                @forelse ($equipes_saude as $equipe_saude)
                    <tr class="border-t hover:bg-gray-50 transition" wire:loading.remove wire:target="searchTerm">
                        ...
                        <td class="px-2 py-1 text-sm font-medium text-gray-800">{{ $equipe_saude->equipe_saude_nome }}
                        </td>
                        <td class="px-2 py-1 text-center space-x-0">
                            <!-- Exibir -->
                            @can('Exibir Equipe de Saude')
                            ...
                            <!-- Deletar -->
                            @can('Deletar Equipe de Saude')
                            <button type="button" wire:click="confirmDelete('{{ $equipe_saude->equipe_saude_id }}')"
                                class="w-7 h-6 inline-flex items-center justify-center bg-red-100 text-red-700 hover:bg-red-200 p-2 transition"
                                title="Deletar Equipe de Saúde">
                                ...
                                <div>
                                    @if ($searchTerm)
                                        <h4 class="text-gray-700 font-semibold text-lg">
                                            Nenhuma equipe de saúde encontrada
                                        </h4>
                                    ...
                                    @else
                                        <h4 class="text-gray-700 font-semibold text-lg">
                                            Nenhuma equipe de saúde cadastrada
                                        </h4>
                                        <p class="text-sm text-gray-500 mt-1">
                                            Comece criando uma nova equipe de saúde.
                                        </p>
                                    @endif
                                </div>
