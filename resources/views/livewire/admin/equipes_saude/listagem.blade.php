<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <input
            ...
            placeholder="Buscar por nome da equipe de saúde..."
        ...
        <a href="{{ route('admin.equipes_saude.formulario') }}"
           ...
           <i class="fa fa-plus"></i> Novo Equipe de Saúde
        </a>
    </div>
        ...
        <table class="hidden md:table min-w-full">
            <thead>
                <tr class="bg-gray-100 text-left text-sm text-gray-600">
                    ...
                    <th class="px-2 py-2 font-semibold">Nome da Equipe de Saúde</th>
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="5" class="text-center py-4 text-gray-500">Nenhum equipe_saude encontrado.</td></tr>
                @endforelse
            </tbody>
        </table>
    ...
    <!-- Paginação -->
    <div class="mt-4">{{ $equipes_saude->links() }}</div>
