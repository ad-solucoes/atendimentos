        ...
        <table class="hidden md:table min-w-full">
            <thead>
                <tr class="bg-gray-100 text-left text-sm uppercase text-gray-600">
                    ...
                    <th class="px-4 py-3">Cartão do SUS</th>
                    <th class="px-4 py-3">CPF nº</th>
                    <th class="px-4 py-3">Nome da Mãe</th>
            ...
            <tbody>
                @forelse ($pacientes as $paciente)
                    <tr class="border-t hover:bg-gray-50 transition">
                        <td class="px-4 py-2 font-medium text-gray-800">{{ $paciente->paciente_nome }}</td>
                        <td class="px-4 py-2 font-medium text-gray-800">{{ $paciente->paciente_cns }}</td>
                        <td class="px-4 py-2 font-medium text-gray-800">{{ $paciente->paciente_cpf }}</td>
                        <td class="px-4 py-2 font-medium text-gray-800">{{ $paciente->paciente_nome_mae }}</td>
