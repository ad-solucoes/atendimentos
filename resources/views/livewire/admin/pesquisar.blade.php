                    ...
                    <tbody>
                        @foreach($pacientes as $paciente)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-2">
                                    <a href="{{ route('admin.pacientes.detalhes', $paciente->paciente_id) }}" class="text-blue-600 hover:underline text-sm">Ver</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                    ...
                    <tbody>
                        @foreach($solicitacoes as $solicitacao)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-2">
                                    <a href="{{ route('admin.solicitacoes.detalhes', $solicitacao->solicitacao_id) }}" class="text-blue-600 hover:underline text-sm">Ver</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
