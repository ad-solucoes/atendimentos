<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-3">
        ...
        @if ($procedimentos->total() > 0)
            <div class="text-sm text-gray-600">
                Mostrando
                <span class="font-semibold text-gray-800">{{ $procedimentos->firstItem() }}</span>
                até
                <span class="font-semibold text-gray-800">{{ $procedimentos->lastItem() }}</span>
                de
                <span class="font-semibold text-gray-800">{{ $procedimentos->total() }}</span>
                registro(s)
                @if ($searchTerm)
