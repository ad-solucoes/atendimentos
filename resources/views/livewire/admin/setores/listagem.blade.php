            ...
            <thead>
                <tr class="bg-gray-100 text-left text-sm text-gray-600">
                    <th class="px-2 py-2 text-center font-semibold" width="100"
                        wire:click="sortByField('setor_status')" style="cursor: pointer;" title="Clique para ordenar">
                        Status
                        @include('livewire.partials._sort-icon', ['field' => 'setor_status'])
                    </th>
                    <th class="px-2 py-2 font-semibold" wire:click="sortByField('setor_nome')" style="cursor: pointer;"
                ...
                @forelse ($setores as $setor)
                    <tr class="border-t hover:bg-gray-50 transition" wire:loading.remove wire:target="searchTerm">
                        ...
                        <td class="px-2 py-1 text-center space-x-0">
                            ...
                            <!-- Deletar -->
                            @can('Deletar Setor')
                            <button type="button" wire:click="confirmDelete('{{ $setor->setor_id }}')"
