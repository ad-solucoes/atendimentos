    ...
    <div class="space-y-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                ...
                <p class="text-gray-800 font-semibold">{{ formatoId($tipo_procedimento->tipo_procedimento_id, 3) }}</p>
            </div>
            <div>
                <h3 class="text-gray-400 text-sm font-medium">Nome do Setor</h3>
                <p class="text-gray-800 font-semibold">{{ $tipo_procedimento->tipo_procedimento_nome }}</p>
            </div>
            <div>
