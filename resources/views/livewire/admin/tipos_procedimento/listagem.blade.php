<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <a href="{{ route('admin.tipos_procedimento.formulario') }}"
           ...
           <i class="fa-solid fa-plus"></i> Novo Tipo de Procedimento
        </a>
    </div>
        ...
        <table class="hidden md:table min-w-full">
            <thead>
                <tr class="bg-gray-100 text-left text-sm uppercase text-gray-600">
                    <th class="px-4 py-3">Nome do Tipo de Procedimento</th>
            ...
            <tbody>
                @forelse ($tipos_procedimento as $tipo_procedimento)
                    <tr class="border-t hover:bg-gray-50 transition">
                        <td class="px-4 py-2 font-medium text-gray-800">{{ $tipo_procedimento->tipo_procedimento_nome }}</td>
                        <td class="px-4 py-2 text-right space-x-0">
                            ...
                            <a href="/tipos_procedimento/{{ $tipo_procedimento->tipo_procedimento_id }}"
                               ...
                               title="Ver Tipo de Procedimento">
                            ...
                            <button type="button"
                                    ...
                                    title="Excluir Tipo de Procedimento">
