        ...
        <table class="hidden md:table min-w-full">
            <thead>
                <tr class="bg-gray-100 text-left text-sm text-gray-600">
                    <th class="px-2 py-2 text-center font-semibold" width="100" wire:click="sortByField('status')" style="cursor: pointer;" title="Clique para ordenar">
                        Status
                        @include('livewire.partials._sort-icon', ['field' => 'status'])
                    </th>
                    <th class="px-2 py-2 font-semibold" wire:click="sortByField('name')" style="cursor: pointer;" title="Clique para ordenar">
                        Nome do Usuário
                    ...
                    <tr wire:loading.remove wire:target="searchTerm">
                        <td colspan="4" class="py-12 text-center">
                            <div class="flex flex-col items-center justify-center space-y-1.5">
                                ...
                                @if(!$searchTerm)
                                    <a href="{{ route('admin.usuarios.formulario') }}" class="mt-3 inline-flex items-center gap-2 bg-blue-700 hover:bg-blue-800 text-white text-sm font-medium px-4 py-2.5 rounded-lg shadow transition-all duration-200">
