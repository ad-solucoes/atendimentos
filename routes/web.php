...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'verified'])->group(function () {
        ...
        Route::prefix('tipos_procedimento')->name('tipos_procedimento.')->group(function () {
            ...
            Route::get('/detalhes/{id?}', App\Livewire\Admin\TiposProcedimento\Formulario::class)->name('detalhes');
        });
        ...
        Route::prefix('procedimentos')->name('procedimentos.')->group(function () {
            ...
            Route::get('/detalhes/{id?}', App\Livewire\Admin\Procedimentos\Formulario::class)->name('detalhes');
        });
        ...
        Route::prefix('equipes_saude')->name('equipes_saude.')->group(function () {
            ...
            Route::get('/detalhes/{id?}', App\Livewire\Admin\EquipesSaude\Formulario::class)->name('detalhes');
        });
        ...
        Route::prefix('agentes_saude')->name('agentes_saude.')->group(function () {
            ...
            Route::get('/detalhes/{id?}', App\Livewire\Admin\AgentesSaude\Formulario::class)->name('detalhes');
        });
        ...
        Route::prefix('pacientes')->name('pacientes.')->group(function () {
            ...
            Route::get('/detalhes/{id?}', App\Livewire\Admin\Pacientes\Formulario::class)->name('detalhes');
        });
        ...
        Route::prefix('atendimentos')->name('atendimentos.')->group(function () {
            ...
            Route::get('/detalhes/{id?}', App\Livewire\Admin\Atendimentos\Formulario::class)->name('detalhes');
        });
